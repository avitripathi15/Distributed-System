...
portB = 2222                                                # port no to connect to Server B
...
def filefetch():
    l1 = []
    for i in os.scandir("/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A"):
...
os.system('rsync  /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/')
...
def on_created(event):                            # Funtion that defines the sync process when file is created
    print("Created")
    if os.access(event.src_path, os.W_OK):
        os.system('rsync /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/')
    sf = filefetch()
...
def on_deleted(event):                           # Funtion that defines the sync process when file is Deleted
    print("Deleted")
    path1 = '/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/'
    filename = os.path.basename(event.src_path)
    file_path = os.path.join(path1, filename)
    if os.path.exists(file_path):
        os.remove(file_path)
        os.system('rsync --ignore-existing --recursive --delete /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/* /Users/avi/Documents/Lab2_Tripathi_axt7928/Test_dir/B/')
    sf = filefetch()
    for i in range(0, len(sf)):
        print(sf[i])
...
def on_modified(event):                         # Funtion that defines the sync process when file is modified
    if os.access(event.src_path,os.W_OK):
        ...
        print("Modified")
        try:
            os.system('rsync --no-p --no-g --chmod=ugo=rwX /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/')
        except:
            print("File Locked")
        sf = filefetch()
        for i in range(0, len(sf)):
...
def wchdg():                                     # Watchdog functions to check the target directory for changes
    path = '/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/'
...
while True:                                           # Checking for connection
    ...
    while data != "exit":                                # Checking For the command
        if data == "lab1":
            ...
            print(lo[0], lo[1])
            v1 = l_fn(lo[-1])
            if lo[0] == "lock":                                 # Fetching the file
                path = os.path.join('/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A', v1)
                os.chmod(path, 0o444)                           #locking the file at administrator

            elif lo[0] == "unlock":
                os.chmod(path, 0o777)                            #unlocking locking the file at administrator
                os.system(
                    'rsync /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/')
