...
port = 2222                                           # Assigning a Port no to the between Server B and Server A
...
def filefetch():
    b = []
    for i in os.scandir("/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B"):
...
os.system('rsync /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/')
...
def on_created(event):                                  # Funtion that defines the sync process when file is created
    print("Created")
    for i in os.scandir("/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B"):
        p = os.path.join('Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B', (str(i.name)))
        mr = (str(i.name))
        ...
        #    os.system(f'rsync -r --exclude={mr} /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/')
             print("request queued")
    sf = filefetch()
    for i in range(0, len(sf)):
        print(sf[i])
...
def on_deleted(event):                                  # Funtion that defines the sync process when file is Deleted
    ...
    if os.path.exists(file_path):
        os.remove(file_path)
        os.system('rsync  --ignore-existing --recursive --delete /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/')
    sf = filefetch()
    for i in range(0, len(sf)):
        print(sf[i])
...
def on_modified(event):                                 # Funtion that defines the sync process when file is modified
    for i in os.scandir("/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B"):
        ...
        if os.access(p , os.W_OK):
            print("Modified")
            os.system('rsync -r /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/* /Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/A/')
            sf = filefetch()
            for i in range(0, len(sf)):
                print(sf[i])
        else:
...
def wchdg():                                             # Watchdog functions to check the target directory for changes
    path = '/Users/avi/Documents/Lab3_Tripathi_axt7928/Test_dir/B/'
